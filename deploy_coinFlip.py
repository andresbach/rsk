...
coinFlip = web3.eth.contract(abi=contract_abi, bytecode=contract_bytecode)
# este es el que deploya desde acc0
tx_hash = coinFlip.constructor().transact(transaction=txargs0)
...
coinFlip = web3.eth.contract(address = contract_address, abi = contract_abi, bytecode = contract_bytecode)

print("Deployment hash:", tx_hash.hex())
print("Deployment address:", coinFlip.address)
